...
const ProductByIdSection = ({ id }: { id: string }) => {
  const {
    data: product,
    isLoading,
    isSuccess,
          ...
          <div className="col-12 col-md-5 col-lg-5 col-xl-5">
            <div>
              ...
              <div className={styles.product__detailsMeta}>
                <span className={styles.product__detailsMetainfo}>دسته : </span>
              ...
              <ul className={styles.product__detailsListInfos}>
                ...
                <li className={styles.product__detailsItemInfos}>
                  <span className={styles.product__infosQuest}>حس‌گرها : </span>
                  <span className={styles.product__infosAnswer}>
                  ...
                  <div className={styles.product__allColors}>
                    {product?.data.colors.map((color) => (
                      ...
                      >
                        {selectColor === color && (
                          <BsCheckLg
                            className={`${styles.colorSelecteor} ${
                              selectColor === "سفید" && styles.blacked
                            }`}
                          />
                        )}{" "}
                      </Link>
              ...
              <div className={styles.product__warning}>
                <p className={styles.product__warningText}>
                  <HiOutlineBellAlert className={styles.product__warningIcon} />
                      ...
                      <div className={styles.resultReview__point}>
                        ...
                        <div className={styles.resultReview__pointWrapper}>
                          <div className={styles.resultReview__pointProgress}>
                            <span
                              className={styles.resultReview__pointProgressBar}
                              style={{
                          ...
                          >
                            {showRatingResultPersian(product?.data.rating ?? 5)}
                          </span>
                        </div>
                      </div>
                    </div>
                          ...
                          >
                            <div className={styles.comment__content}>
                              <div className={styles.comment__meta}>
                                <div
                                  className={`  ${styles.comment__metaRating} ${
                                    review?.rating > 3
                                      ? styles.green
                                      : review?.rating > 2
                                      ? styles.orange
                              ...
                              <div className={styles.comment__description}>
                                <p className={styles.comment__descriptionText}>
                                  {review.description}
                                </p>
                              </div>
              ...
              <div className="row">
                ...
                <div className="col-12 col-sm-12 col-md-4">
                  <div className={styles.pointBad__wrapper}>
                    ...
                    <ul>
                      <li>
                        <TbTriangleInverted className={styles.pointBad__icon} />
                        قيمت زياد
                      </li>
                      <li>
                        <TbTriangleInverted className={styles.pointBad__icon} />
...
export default ProductByIdSection;
